...
public class BlueberryBush extends Structure
{
	...
	public BlueberryBush(EntityStore<Entity> root, Point2D location, boolean friendly, double health)
	{
	...
	private static Image[][] loadSprite()
	{
		try
		{
			...
			sprite[0][0] = new Image(new FileInputStream("assets/tempBlueberryBush.png"));
	...
	public void tick(long millis)
	{
		...
		if (timeToSpawn <= 0)
		{
			...
			for (int i = 0; i < count; i++)
			{
				...
				root.add(new Blueberry(root, point, rally, friendly));
			}
		}
	}
